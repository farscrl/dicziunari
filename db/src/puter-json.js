...
const FILE_PATH = 'data/pledarigrond_export_json_puter.json';
// const FILE_PATH = 'data/pledarigrond_export_json_puter_short.json';
...
module.exports = {
    main: function () {
        console.log('Start converting JSON file for Puter...');
