...
const FILE_PATH = 'data/pledarigrond_export_json_vallader.json';
// const FILE_PATH = 'data/pledarigrond_export_json_vallader_short.json';
...
module.exports = {
    main: function () {
        console.log('Start converting JSON file for Vallader...');
