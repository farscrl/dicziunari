...
const FILE_PATH = 'data/pledarigrond_export_json_sutsilvan.json';
// const FILE_PATH = 'data/pledarigrond_export_json_sutsilvan_short.json';
...
module.exports = {
    main: function () {
        console.log('Start converting JSON file for Sutsilvan...');
